...
(function (g) {
  ...
  p(r.prototype, {
    ...
    init: function (b, a) {
      var d = b.options.legend.layout !== 'vertical',
        c;
    ...
    tweenColors: function (b, a, d) {
      ...
      return (
        (c ? 'rgba(' : 'rgb(') +
        Math.round(a.rgba[0] + (b.rgba[0] - a.rgba[0]) * (1 - d)) +
        ',' +
        Math.round(a.rgba[1] + (b.rgba[1] - a.rgba[1]) * (1 - d)) +
        ',' +
        Math.round(a.rgba[2] + (b.rgba[2] - a.rgba[2]) * (1 - d)) +
        (c ? ',' + (a.rgba[3] + (b.rgba[3] - a.rgba[3]) * (1 - d)) : '') +
        ')'
      );
    },
    initDataClasses: function (b) {
      ...
      k(b.dataClasses, function (f, i) {
        ...
        c.push(f);
        if (!f.color)
          h.dataClassColor === 'category'
            ? ((g = d.options.colors), (f.color = g[e++]), e === g.length && (e = 0))
            : (f.color = a.tweenColors(
                o(h.minColor),
                o(h.maxColor),
                i / (b.dataClasses.length - 1),
              ));
      });
    },
    ...
    getOffset: function () {
      ...
      if (b && (j.prototype.getOffset.call(this), !this.axisGroup.parentGroup))
        (this.axisGroup.add(b), this.gridGroup.add(b), this.labelGroup.add(b), (this.added = !0));
    },
    ...
    drawLegendSymbol: function (b, a) {
      var d = b.padding,
        c = b.options,
        e = this.horiz,
        h = q(c.symbolWidth, e ? 200 : 12),
        f = q(c.symbolHeight, e ? 12 : 200),
        c = q(c.labelPadding, e ? 10 : 30);
      this.setLegendColor();
      a.legendSymbol = this.chart.renderer
        .rect(0, b.baseline - 11, h, f)
        .attr({ zIndex: 1 })
        .add(a.legendGroup);
    ...
    getSeriesExtremes: function () {
      ...
      if (this.series.length)
        ((b = this.series[0]), (this.dataMin = b.valueMin), (this.dataMax = b.valueMax));
    },
    drawCrosshair: function (b, a) {
      var d = !this.cross,
        ...
        i = this.len;
      if (a)
        ((h = this.toPixels(a.value)),
          h < f ? (h = f - 2) : h > f + i && (h = f + i + 2),
          (a.plotX = h),
          (a.plotY = this.len - h),
          j.prototype.drawCrosshair.call(this, b, a),
          (a.plotX = c),
          (a.plotY = e),
          !d && this.cross && this.cross.attr({ fill: this.crosshair.color }).add(this.labelGroup));
    },
    getPlotLinePath: function (b, a, d, c, e) {
      return e
        ? this.horiz
          ? ['M', e - 4, this.top - 6, 'L', e + 4, this.top - 6, e, this.top, 'Z']
          : ['M', this.left, e, 'L', this.left - 6, e + 6, this.left - 6, e - 6, 'Z']
        : j.prototype.getPlotLinePath.call(this, b, a, d, c);
    },
    update: function (b, a) {
      k(this.series, function (a) {
        a.isDirtyData = !0;
      });
      j.prototype.update.call(this, b, a);
  ...
  w(y.prototype, 'getAllItems', function (b) {
    ...
    d &&
      (d.options.dataClasses ? (a = a.concat(d.getDataClassLegendSymbols())) : a.push(d),
  ...
  u.plotOptions.heatmap = l(u.plotOptions.scatter, {
    animation: !1,
    borderWidth: 0,
    nullColor: '#F8F8F8',
    dataLabels: {
    ...
    l(g, {
      ...
      translate: function () {
        ...
        k(this.points, function (c) {
          var e = (b.colsize || 1) / 2,
            h = (b.rowsize || 1) / 2,
            f = Math.round(a.len - a.translate(c.x - e, 0, 1, 0, 1)),
            e = Math.round(a.len - a.translate(c.x + e, 0, 1, 0, 1)),
            g = Math.round(d.translate(c.y - h, 0, 1, 0, 1)),
            h = Math.round(d.translate(c.y + h, 0, 1, 0, 1));
          c.plotX = (f + e) / 2;
          c.plotY = (g + h) / 2;
          c.shapeType = 'rect';
          c.shapeArgs = {
