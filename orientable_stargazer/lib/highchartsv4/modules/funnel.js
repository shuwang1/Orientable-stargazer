...
(function (b) {
  ...
  q.funnel = b.extendClass(q.pie, {
    ...
    translate: function () {
      var a = function (j, a) {
          return /%$/.test(j) ? (a * parseInt(j, 10)) / 100 : parseInt(j, 10);
        },
        B = 0,
        f = this.chart,
        c = this.options,
        ...
        x,
        y,
        v = c.dataLabels.position === 'left' ? 1 : 0,
        z,
        l,
        C,
        p,
      ...
      A(a, function (a) {
        ...
        l > w
          ? ((z = p = h - s / 2), (C = u = h + s / 2))
          : i > w && ((m = i), (k = r(w)), (p = h - k / 2), (u = p + k), (i = w));
    ...
    drawPoints: function () {
      ...
      A(a.data, function (c) {
        ...
        g
          ...
          : (c.graphic = f
              .path(d)
              .attr({ fill: c.color, stroke: b.borderColor, 'stroke-width': b.borderWidth })
              .add(a.group));
      });
    },
    ...
    drawDataLabels: function () {
      var a = this.data,
        ...
        n,
        o;
      for (this.center[2] -= 2 * b; d--; )
        ((g = a[d]),
          (c = (f = g.half) ? 1 : -1),
          (o = g.plotY),
          (n = this.getX(o, f)),
          (g.labelPos = [0, o, n + (b - 5) * c, o, n + b * c, o, f ? 'right' : 'left', 0]));
