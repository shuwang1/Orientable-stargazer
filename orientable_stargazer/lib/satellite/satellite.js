...
satellite = (function () {
  ...
  function dscom(dscom_parameters) {
    ...
    *    vallado, crawford, hujsak, kelso  2006
    ...
    var z1, z2, z3, z11, z12, z13, z21, z22, z23, z31, z32, z33;
    ...
    xnodce = (4.523602 - 9.2422029e-4 * day) % twopi;
    ...
    var gam = 5.8351514 + 0.001944368 * day;
  ...
  function dsinit(dsinit_parameters) {
    ...
    *    vallado, crawford, hujsak, kelso  2006
    ...
    var sini2, temp, temp1, theta, xno2, ainv2, aonv, cosisq, eoc;
  ...
  function twoline2rv(longstr1, longstr2) {
    ...
    satrec.bstar = parseFloat(
      '.' + parseInt(longstr1.substring(53, 59), 10) + 'E' + longstr1.substring(59, 61),
    );
  ...
  function eci_to_geodetic(eci_coords, gmst) {
    ...
    var latitude = Math.atan2(
      eci_coords['z'],
      Math.sqrt(eci_coords['x'] * eci_coords['x'] + eci_coords['y'] * eci_coords['y']),
    );
    var C;
    while (k < kmax) {
